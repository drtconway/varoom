...
namespace varoom
{
    namespace seq
    {
        ...
        static const genome_map& hg19()
        {
            static nlohmann::json hg19Json = R"({
                "chr1": 249250621,
                "chr2": 243199373,
                "chr3": 198022430,
                "chr4": 191154276,
            ...
            static genome_map hg19Map(hg19Json);

            return hg19Map;
        }

        static const genome_map& hg38()
        {
            static nlohmann::json hg38Json = R"({
                "chr1": 248956422,
                "chr2": 242193529,
                "chr3": 198295559,
                "chr4": 190214555,
            ...
            static genome_map hg38Map(hg38Json);
